...
template <typename T> class EnumPool : public AbstractEnumPool {
  ...
  /**
   * values from the perspective of the files specification, i.e. this table is
   * used to decode values from disc
   */
  api::EnumProxy<T> **fileValues;
  size_t fvCount;

  /**
   * values from the perspective of the tools specification, i.e. this table is
   * used to convert enum values to proxies
   */
